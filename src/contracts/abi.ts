export const contract_address = '0x2Ac7408E4628601FeCFf25601eDdDda754a3ac5b'
export const CONTRACT_ABI = [
  ...
  {
    inputs: [{ internalType: 'address', name: '_refferer', type: 'address' }],
    name: 'deposit',
    outputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'newDailyROI', type: 'uint256' },
    ],
    name: 'editPackage',
    outputs: [],
    stateMutability: 'nonpayable',
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'totalBLRIncome', type: 'uint256' },
          {
            internalType: 'uint256',
  ...
  {
    inputs: [
      { internalType: 'address', name: '_newFeeWallet', type: 'address' },
    ],
    name: 'setFeeWallet',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'stakerTeams',
    outputs: [
      { internalType: 'uint256', name: 'levelBusiness', type: 'uint256' },
      { internalType: 'uint256', name: 'levelBonuse', type: 'uint256' },
      { internalType: 'uint256', name: 'levelTeam', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'balance', type: 'uint256' },
      { internalType: 'uint256', name: 'totalStaked', type: 'uint256' },
      { internalType: 'uint256', name: 'totalLevelIncome', type: 'uint256' },
      { internalType: 'uint256', name: 'totalDirectIncome', type: 'uint256' },
      { internalType: 'uint256', name: 'totalBLRIncome', type: 'uint256' },
      { internalType: 'uint256', name: 'totalRewardIncome', type: 'uint256' },
      { internalType: 'uint256', name: 'totalCashbackIncome', type: 'uint256' },
      { internalType: 'uint256', name: 'lastClaim', type: 'uint256' },
      { internalType: 'uint256', name: 'currentPackageIndex', type: 'uint256' },
      { internalType: 'address', name: 'referrer', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
