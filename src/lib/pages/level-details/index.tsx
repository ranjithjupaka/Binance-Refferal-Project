...
const index = () => {
  ...
  const { contract } = useContract(contract_address, CONTRACT_ABI)
    const {
      data: level1Data,
      isLoading: islevel1DataLoading,
      error: level1DataError,
    ...
    } = useContractRead(contract, 'stakerTeams', [address, 6])
    return (
      <>
            ...
            <Table className='w-full'>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>
                    {level1Data && level1Data['levelTeam'].toString()}
                  </TableCell>
                  <TableCell>
                    {level2Data &&
                      level1Data['levelBonuse'].toString() / 1000000000}
                  </TableCell>
                  <TableCell>
                    {level1Data &&
                      level1Data['levelBusiness'].toString() / 1000000000}
                  </TableCell>
                </TableRow>
                <TableRow>
